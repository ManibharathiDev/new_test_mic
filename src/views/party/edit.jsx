                  ...
                  <Col md={6}>
                    <Form.Group className="mb-3" controlId="formLeder">
                      ...
                      <Form.Control
                        ...
                        name="leader"
                        onChange={handleChange}
                        placeholder="Enter the name of the Leader"
                      />
                    </Form.Group>
                  </Col>
                  <Col md={6}>
                    <Form.Group className="mb-3" controlId="formDescription">
                      ...
                      <Form.Control
                        type="text"
                        value={data.head_quarter}
                        name="head_quarter"
                        onChange={handleChange}
                        placeholder="Enter the Head Quarter Name"
                      />
                    </Form.Group>
                  </Col>
                </Row>
                  ...
                  <Col md={6}>
                    <Form.Group className="mb-3" controlId="formYear">
                      ...
                      <Form.Control
                        ...
                        onChange={handleChange}
                        placeholder="Enter the year of start"
                      />
                    </Form.Group>
                  </Col>
                  <Col md={6}>
                  ...
                  <Col md={6}>
                    <Form.Group className="mb-3" controlId="formNameParty">
                      ...
                      <Form.Control
                        ...
                        name="mobile_number"
                        onChange={handleChange}
                        placeholder="Enter the official Mobile Number"
                      />
                    </Form.Group>
                  </Col>
                  <Col md={6}>
