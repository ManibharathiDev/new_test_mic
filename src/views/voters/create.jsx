...
const CreateVoters = () =>{
  ...
  if(secureLocalStorage.getItem("STATUS") != null)
    ...
    const [rows, setRows] = useState([
        { id: 1,  VOTER_NAME: '', EPIC_NUMBER: '', BOOTH_ADDRESS: '', BOOTH_NUMBER: '', LINE_NUMBER: '', FATHER_NAME: '',HUSBAND_NAME: '',GENDER: '',AGE: '' },
      ]);
    const renderLokSaba = () =>{
    ...
    const addRow = () =>{
        setRows([...rows, { id: rows.length + 1, VOTER_NAME: '', EPIC_NUMBER: '', BOOTH_ADDRESS: '', BOOTH_NUMBER: '', LINE_NUMBER: '', FATHER_NAME: '',HUSBAND_NAME: '',GENDER: '',AGE: '' }]);
    }  
    ...
    const handleReset = () => {
      ...
      const renderHeader = () => {
        let headerElement = ['#', 'Voter Name', 'EPIC Number', 'Booth Address','Booth Number','Line Number','Father Name','Husband Name','Gender','Age','Action']
              ...
              <Card>
                ...
                <Form onSubmit={handleSubmit}>       
                  ...
                  {rows.map((row, index) => (
                        <tr key={row.id}>
                        <td>{row.id}</td>
                        <td><input type="text" name="VOTER_NAME" value={row.VOTER_NAME}  onChange={(e) => handleInputChange(e, index)}/></td>
                        <td><input type="text" name="EPIC_NUMBER" value={row.EPIC_NUMBER} onChange={(e) => handleInputChange(e, index)}/></td>
                        <td><input type="text" name="BOOTH_ADDRESS" value={row.BOOTH_ADDRESS} onChange={(e) => handleInputChange(e, index)}/></td>
                        <td><input type="text" name="BOOTH_NUMBER" value={row.BOOTH_NUMBER} onChange={(e) => handleInputChange(e, index)}/></td>

                        <td><input type="text" name="LINE_NUMBER" value={row.LINE_NUMBER} onChange={(e) => handleInputChange(e, index)}/></td>

                        <td><input type="text" name="FATHER_NAME" value={row.FATHER_NAME} onChange={(e) => handleInputChange(e, index)}/></td>

                        <td><input type="text" name="HUSBAND_NAME" value={row.HUSBAND_NAME} onChange={(e) => handleInputChange(e, index)}/></td>

                        <td><input type="text" name="GENDER" value={row.GENDER} onChange={(e) => handleInputChange(e, index)}/></td>

                        <td><input type="text" name="AGE" value={row.AGE} onChange={(e) => handleInputChange(e, index)}/></td>
