                 ...
                 <Form onSubmit={handleSubmit}>  
                        <Row>
                            ...
                            <Form.Group className="mb-3" controlId="formNameParty">
                                ...
                                <Form.Control type="text" value={data.country_code} name='country_code' onChange={handleChange} placeholder="Enter the Country Code" />
                            ...
                            <Form.Group className="mb-3" controlId="formDescription">
                                ...
                                <Form.Control type="text" value={data.name} name='name' onChange={handleChange}  placeholder="Enter the Country Name" />
